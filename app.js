...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("form__edit-mode");
  //If class of the parent is .form__edit-mode
  if (containsClass) {

    //switch to .form__edit-mode
  ...
  //toggle .form__edit-mode on the parent.
  listItem.classList.toggle("form__edit-mode");
};
